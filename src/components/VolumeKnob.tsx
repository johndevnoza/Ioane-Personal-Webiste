...
const VolumeKnob = () => {
  ...
  const handlePowerAlert = () => {
    alert("first turn on the device");
  };
  ...
  return (
    ...
    >
      ...
      <div
        className={`relative rounded-full border-2 border-white/20 bg-white/15 from-elementBgColor ${tooltip === "wheelButton3" ? "outline -outline-offset-2 outline-selectedColor" : ""}`}
      >
        <div
