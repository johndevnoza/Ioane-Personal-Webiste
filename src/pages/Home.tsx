...
const Home = () => {
  ...
  return (
    <div className="flex h-screen w-full items-center overflow-hidden bg-[#878695] p-2">
      <div className="relative z-40 m-auto flex h-full w-full select-none overflow-hidden rounded-[24px] border-2 border-black bg-elementBgDark p-1 shadow-2xl drop-shadow-2xl max-[1110px]:min-w-full md:h-[80%] md:w-[80%]">
